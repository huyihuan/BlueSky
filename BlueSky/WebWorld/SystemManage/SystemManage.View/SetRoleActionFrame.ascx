<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SetRoleActionFrame.ascx.cs" Inherits="WebWorld.SystemManage.SetRoleActionFrame" %>
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        panel.init({
            ...
            width: "100%",
            height: "100%",
            splitPanel: [{ title: "系统功能列表", width: "150", content: "#treeContainer" }, { title: "功能操作" , content: "请选择左边的功能树！" }]
        });
    });
...
<div id="treeContainer" style="width:100%;height:100%;overflow:auto;"><%=strTree %></div>