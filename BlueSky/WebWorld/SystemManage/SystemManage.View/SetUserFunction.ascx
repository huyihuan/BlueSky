<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SetUserFunction.ascx.cs" Inherits="WebWorld.SystemManage.SetUserFunction" %>
            ...
            <div class="list-container">
                <table class="table-list table-list-topline" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        ...
                        <td align="center" class="td-header">权限名称</td>
                        <td align="center" class="td-header-last">说明</td>
                    </tr>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td class="td-content"><asp:Label ID="lbl_FunctionName" runat="server"></asp:Label></td>
                            <td align="center" class="td-content-last"><asp:Label ID="lbl_Remark" runat="server"></asp:Label></td>
                        </tr>
                    </ItemTemplate>
                    </asp:Repeater>
                </table>
