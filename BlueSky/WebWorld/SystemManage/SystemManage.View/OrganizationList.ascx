<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OrganizationList.ascx.cs" Inherits="WebWorld.SystemManage.OrganizationList" %>
            ...
            <div class="list-container">
                <table class="table-list table-list-topline" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        ...
                        <td align="center" class="td-header">组织机构名称</td>
                        <td align="center" class="td-header">组织机构类型</td>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td class="td-content"><asp:Literal ID="lit_OrganizationTypeName" runat="server"></asp:Literal></td>
