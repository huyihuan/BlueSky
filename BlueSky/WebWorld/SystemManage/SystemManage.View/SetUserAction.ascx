<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SetUserAction.ascx.cs" Inherits="WebWorld.SystemManage.SetUserAction" %>
<table  cellpadding="0" cellspacing="0" height="100%" width="100%">
    ...
    <tr>
        ...
        <td width="50%" align="right"><input type="button" value="返 回" class="btn-normal" onclick="top.windowFactory.closeTopFocusForm();"  />&nbsp;</td>
    </tr>
    <tr><td colspan="2" height="5"></td></tr>
    <tr>
