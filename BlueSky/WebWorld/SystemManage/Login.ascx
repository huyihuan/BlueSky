...
<script type="text/javascript">
    ...
    $(document).ready(function() { document.getElementById("<%=txt_UserName.ClientID %>").focus(); });
</script>
<table cellpadding="0" cellspacing="5" width="100%">
    ...
    <tr>
        ...
        <td><input type="text" id="txt_VCode" runat="server" class="txt-normal" autocomplete="off"  style="width:117px;" /></td>
    </tr>
    <tr>
        <td>&nbsp;</td>
