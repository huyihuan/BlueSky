...
namespace WebWorld.SystemManage
{
    public partial class ModuleUpdate : System.Web.UI.UserControl
    {
        ...
        protected void btn_UpdateModule_Click(object sender, EventArgs e)
        {
            ...
            oModuleExist.OrderId = Util.ParseInt(_GetChildNodeText(moduleNode, "OrderId"), 1);
            ...
            foreach (XmlNode nodeRootFn in nlFnsRoot)
            {
                ...
                oFnExist.OrderId = Util.ParseInt(_GetChildNodeText(nodeRootFn, "OrderId"), 1);
                ...
                foreach (XmlNode nodeAction in nlActions)
                {
                    ...
                    oActionExist.IsDefault = Util.ParseInt(_GetChildNodeText(nodeAction, "IsDefault"), 2);
                    ...
                    oActionExist.EntityCount = Util.ParseInt(_GetChildNodeText(nodeAction, "EntityCount"), 0);
                    oActionExist.IsPopup = Util.ParseInt(_GetChildNodeText(nodeAction, "IsPopup"), 2);
                    oActionExist.Width = Util.ParseInt(_GetChildNodeText(nodeAction, "Width"), 0);
                    oActionExist.Height = Util.ParseInt(_GetChildNodeText(nodeAction, "Height"), 0);
                    oActionExist.IsResize = Util.ParseInt(_GetChildNodeText(nodeAction, "IsResize"), 2);
                    oActionExist.IsMove = Util.ParseInt(_GetChildNodeText(nodeAction, "IsMove"), 2);
                    oActionExist.IsIncludeMinBox = Util.ParseInt(_GetChildNodeText(nodeAction, "IsIncludeMinBox"), 2);
                    oActionExist.IsIncludeMaxBox = Util.ParseInt(_GetChildNodeText(nodeAction, "IsIncludeMaxBox"), 2);
                    oActionExist.IsShowInTaskBar = Util.ParseInt(_GetChildNodeText(nodeAction, "IsShowInTaskBar"), 2);
                    oActionExist.OrderId = Util.ParseInt(_GetChildNodeText(nodeAction, "OrderId"), 1);
